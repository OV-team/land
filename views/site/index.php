        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    ...
                    <!-- /.logo -->
                    <div class="logo"><a href=""><h2>OV-Team</h2></a></div>
                    ...
                    <div class="landing-text">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed placerat fermentum finibus.
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec fringilla vulputate arcu, sit
                            amet congue mi tristique at. Mauris ac fringilla tortor, at varius nulla. Aliquam erat
                            volutpat. Proin aliquam est nisi, vitae pellentesque orci bibendum a. Duis vel urna
                            ultricies, ultrices eros et, semper ipsum</p>
                    </div>

                    <!-- /.header button -->
                    <div class="head-btn">
                        <!-- <a href="#feature" class="btn-primary">Features</a> -->
                        <a href="#download" class="btn-default">Create Landing Page!</a>
                    </div>
        ...
        <div class="container">
            ...
            <div id="navbar-scroll" class="collapse navbar-collapse navbar-backyard navbar-right">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="#contact">Tex поддержка</a></li>
                    <!--Если пользователь залогинен то показывать жтот пункт меню, по клику поп ап окно с письмом в тех поддержку-->
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1 col-sm-12 text-center feature-title">
                ...
                <p>Increase your user loyalty by maintaining mutual communication and nurturing your online
                    community.</p>
            </div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-sm-4 feat-list">
                    ...
                    <div class="inner">
                        ...
                        <p>Content builds relationships. Relationships are built on trust. Trust drives revenue. -
                            Andrew Davis</p>
                    </div>
                </div>
                ...
                <div class="col-sm-4 feat-list">
                    ...
                    <div class="inner">
                        ...
                        <p>Never doubt a small group of thoughtful, committed people can change the world. Indeed, it is
                            the only thing that ever has.</p>
                    </div>
                </div>
                ...
                <div class="col-sm-4 feat-list">
                    ...
                    <div class="inner">
                        ...
                        <p>Instead of using technology to automate processes, think about using technology to enhance
                            human interaction.</p>
                    </div>
                </div>
...
<!-- /.download section -->
<div id="download">
    <div class="action fullscreen parallax" style="background-image:url('images/bg.jpg');" data-img-width="2000"
         data-img-height="1333" data-diff="100">
        <div class="overlay">
            <div class="container">
                <div class="col-md-8 col-md-offset-2 col-sm-12 text-center">
                    ...
                    <!-- /.download title -->
                    <h2 class="wow fadeInRight">Все еще не решили?</h2>

                    <p class="download-text wow fadeInLeft">Кнопка ниже ведет на регистрацию (если аноним) и на страницу
                        личного кабинета если залогинен</p>

                    <!-- /.download button -->
                    <div class="download-cta wow fadeInLeft">
                        <a href="#contact" class="btn-secondary">Create Landing page</a>
                    </div>
                </div>
            </div>
        </div>
...
<div id="package">
    <div class="container">
        <div class="text-center">
            ...
            <!-- /.pricing title -->
            <h2 class="wow fadeInLeft">Price</h2>
                ...
                <div id="owl-testi" class="owl-carousel owl-theme wow fadeInUp">
                    ...
                    <div class="testi-item">
                        ...
                        <div class="box">
                            ...
                            <!-- /.testimonial content -->
                            <p class="message text-center">"We are very happy and satisfied with Backyard service. Our
                                account manager is efficient and very knowledgeable. It was able to create a vast fan
                                base within very short period of time. We would highly recommend Backyard App to
                                anyone."</p>
                        </div>
                    ...
                    <div class="testi-item">
                        ...
                        <div class="box">
                            ...
                            <!-- /.testimonial content -->
                            <p class="message text-center">"Everything looks great... Thanks for the quick revision turn
                                around. We were lucky to find you guys and will definitely be using some of your other
                                services in the near future."</p>
                        </div>
                        <div class="client-info text-center">
                    ...
                    <div class="testi-item">
                        ...
                        <div class="box">
                            ...
                            <!-- /.testimonial content -->
                            <p class="message text-center">"Overall, the two reports were very clear and helpful so
                                thank you for the suggestion to do the focus group. We are currently working with our
                                developer to implement some of these suggestions."</p>
                        </div>
                        <div class="client-info text-center">
...
<!-- /.contact section -->
<div id="contact">
    <div class="contact fullscreen parallax" style="background-image:url('images/bg.jpg');" data-img-width="2000"
                        ...
                        <form method="POST" id="contact-form" class="form-horizontal" action="contactengine.php"
                            ...
                            <div class="form-group">
                                <textarea name="Message" rows="20" cols="20" id="Message"
                                          class="form-control input-message" placeholder="Message" required></textarea>
                            </div>
                            <div class="form-group">
...
<footer id="footer">
    <div class="container">
        <div class="col-sm-4 col-sm-offset-4">
            ...
            <div class="text-center wow fadeInUp" style="font-size: 14px;">Copyright Backyard 2015 - Template by <a
                    href="http://www.moxdesign.com">MoxDesign</a></div>
